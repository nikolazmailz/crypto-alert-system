...
| **Дата** | 2026-MM-DD                              |
| **Авторы** | СУБО 2020                               |
| **Stakeholders** | @architect, @qa-lead, @devops-engineers |

---

## Контекст

Команда нуждается в едином и формализованном подходе к работе с системой контроля версий. Без согласованных правил мы рискуем получить:
